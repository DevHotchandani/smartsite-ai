...
<body class="p-[10px]">
  <h1 class="text-[30px] font-[700]">Welcome to SmartSite AI</h1>
</body>
</html>
    `
  );
  ...
  const downloadCode = ()=> {
    let filename = "smartSiteAICode.html";
...
6. **UI Sections** (as per user request):  
   ...
   - **Footer** with the text: "Made with SmartSite AI"  
  ...
  return (
    <>
      ...
      <div className="container">
        <h3 className='text-[30px] font-[700]'>Create beautiful websites with <span className='bg-gradient-to-br from-blue-400  to-cyan-600 bg-clip-text text-transparent'>SmartSite AI</span></h3>
